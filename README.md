...
Note: This SQL project is a database reimplementation of that real system,
built with sample data for portfolio demonstration purposes.
...
Designed by Hafsa Mughal | Business Systems Analyst | Islamabad, Pakistan
MS Data Science — Bahria University | BS Bioinformatics — Quaid-e-Azam University
